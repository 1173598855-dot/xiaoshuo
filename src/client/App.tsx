...
export function App() {
  ...
  const systemHealthPanel = systemHealthOpen && bookDetails ? <SystemHealthPanel book={bookDetails} run={runState.details} api={autoApi} onClose={() => setSystemHealthOpen(false)} /> : null;
