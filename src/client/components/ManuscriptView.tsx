...
export function ManuscriptView({ book, chapters, api, onBack, onImported, onOpenNavigation, onOpenCommandPalette }: ManuscriptViewProps) {
    ...
    <main className="manuscript-page" data-print-template={printTemplate} aria-label="正式正文">
      <header className="page-topbar">
        ...
        <div className="page-topbar-actions">
          <WorkbenchQuickActions actions={[{ id: "print", label: "打印 / PDF", icon: Printer, onSelect: () => window.print() }, { id: "export-docx", label: "导出 DOCX", icon: Download, onSelect: () => void exportBook("docx") }, { id: "back-production", label: "返回生产室", icon: ArrowLeft, onSelect: onBack }]} onOpenNavigation={onOpenNavigation} onOpenCommandPalette={onOpenCommandPalette} />
